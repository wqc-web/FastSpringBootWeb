...
public class RedisUtil implements Serializable {
     ...
     */
    private static final long serialVersionUID = -2718756147609434448L;

    /**
     * @Field redisTemplate : redis模板
     */
    @Autowired
...
//            throw new RuntimeException("递减因子必须大于0");
    ...
    public String get(String key) {
        ...
        return ProtoStuffSerializerUtil.deserialize(result, String.class);
    }
